...
public class poly_cp_2D_raw {
  ...
  public static Model run() {
	...
	model.modelPath("/u/home/c/cmcelfre/project-jmarian/RX/");
	...
	model.component("comp1").geom("geom1").feature("sq1").set("size", "3.00e-06");
  ...
  public static Model run4(Model model) {
	...
	model.component("comp1").physics("w").feature("dir2").set("r", new String[][]{{"3.00e-04[m/s]*t"}, {"0"}});
	...
	model.study("std1").feature("time").set("tlist", "range(0,7.00e-06,3.50e-05)");
	...
	model.sol("sol1").feature("v1").set("clist", new String[]{"range(0,7.00e-06,3.50e-05)", "1.000E-8[s]"});
    model.sol("sol1").feature("t1").set("control", "user");
	model.sol("sol1").feature("t1").set("tlist", "range(0,7.00e-06,3.50e-05)");
